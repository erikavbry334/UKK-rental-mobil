            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="reservation-form" name="gs" method="submit" role="search" action="#">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 style="background: #115d64;" class="text-white py-2 text-center"> Pesanan</em></h4>
                            </div>
                            <div class="col-lg-6">
                                <img src="{{ asset($armada->gambar) }}" alt="">
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="col-lg-12" >
                    ...
                    <form id="reservation-form" method="POST" action="/checkout">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <fieldset>
                                    <label for="chooseGuests" class="form-label">jumlah_unit</label>
                                    <input type="number" name="jumlah_unit" value="{{request()->jumlah_unit}}" readonly>
                            </div>
                            <div class="col-lg-4">
                                <fieldset>
                                    <label for="Number" class="form-label">tgl_sewa</label>
                                    <input type="date" name="tgl_pesan" class="date" required>
                                </fieldset>
                            </div>
                            <div class="col-lg-4">
